class Container:
    ...
    @staticmethod
    def get_price_by_type_and_material(container_type):
        for container in Container.containers:
...
Container('Напівпідземний', './resources/pivpidzemniy.png', 'Профіль настил кольоровий', 'Об`єм 3,8 м^3', 3.8, 150)
Container('Напівпідземний', './resources/pivpidzemniy.png', 'Профіль настил кольоровий', 'Об`єм 5.0 м^3', 5.0, 150)
Container('Напівпідземний', './resources/pivpidzemniy.png', 'Сталь нержавіюча перфорована', 'Об`єм 2,5 м^3', 2.5, 150)
Container('Напівпідземний', './resources/pivpidzemniy.png', 'Сталь нержавіюча перфорована', 'Об`єм 3,8 м^3', 3.8, 150)
Container('Напівпідземний', './resources/pivpidzemniy.png', 'Сталь нержавіюча перфорована', 'Об`єм 5.0 м^3', 5.0, 150)
Container('Напівпідземний', './resources/pivpidzemniy.png', 'Деревина різних порід', 'Об`єм 2,5 м^3', 2.5, 150)
Container('Напівпідземний', './resources/pivpidzemniy.png', 'Деревина різних порід', 'Об`єм 3,8 м^3', 3.8, 150)
Container('Напівпідземний', './resources/pivpidzemniy.png', 'Деревина різних порід', 'Об`єм 5.0 м^3', 5.0, 150)
Container('Сортувальний', './resources/sortyvalniy.png', '', '3в1 330 літрів', 0, 120)
Container('Сортувальний', './resources/sortyvalniy.png', '', '3в1 540 літрів', 0, 120)
Container('Сортувальний', './resources/sortyvalniy.png', '', 'Дзвін', 0, 120)
Container('Сортувальний', './resources/sortyvalniy.png', '', 'Трапеція', 0, 120)
Container('Для небезпечних відходів', './resources/kontainer for nebezpech.png', '', 0, 'Звичайний', 120)
Container('Для небезпечних відходів', './resources/kontainer for nebezpech.png', '', 0, 'Сіті-Лайт', 120)
Container('Вулична урна', './resources/vylurna.png', '', 'Для сміття різних фракцій', 0, 120)
Container('Вулична урна', './resources/vylurna.png', '', 'Для сміття з попільничкою', 0, 120)
Container('Вулична урна', './resources/vylurna.png', '', 'З дерев`яними вставками', 0, 120)
Container('Вулична урна', './resources/vylurna.png', '', 'Для використаних стаканчиків', 0, 120)
